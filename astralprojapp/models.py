...
class Client(models.Model):
	...
	residential_address= models.CharField(max_length=64, default='update your account', null=True, blank=True)
	badge= models.CharField(max_length=20, choices=[
		('Beginner', 'Beginner'),
		('New Investor', 'New Investor'),
		('Active Investor', 'Active Investor'),
		('Top Investor', 'Top Investor'),
		], default='Beginner')
...
class Wallet(models.Model):
	...
	usdterc20= models.CharField(max_length=68, null=True, blank=True)
	xrp= models.CharField(max_length=68, null=True, blank=True)
	USDC= models.CharField(max_length=68, null=True, blank=True)

	def __str__(self):
		return f"BigTc Caution: Don't add multiple wallet address for one coin."
